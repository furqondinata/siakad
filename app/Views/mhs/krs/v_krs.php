...
<div class="row">
    <div class="col-sm-12">
        <table class="table-striped table-responsive">
            ...
            <tr>
                <th rowspan="7"><img src="<?= base_url('fotomhs/' . $mhs['foto_mhs']) ?>" height="170px" width="140px"> </th>
    ...
    <div class="col-sm-12">
        <button class="btn btn-xs btn-primary" data-toggle="modal" data-target="#add"> <i class="fa fa-plus"></i> Tambah Mata Kuliah</button>
        <a href="<?= base_url('krs/print') ?>" target="_blank" class="btn btn-xs btn-success"><i class="fa fa-print"></i> Print KRS</a>
    </div>
    <div class="col-sm-12">
        <?php
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?= base_url('krs/delete/' . $value['id_krs']) ?>" type="submit" class="btn btn-success">Delete</a>
                </div>
