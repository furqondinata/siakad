        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    apakah anda yakin ingin menghapus <b><?= $value['matkul'] ?> | <?= $value['nama_dosen'] ?>?</b>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger pull-left" data-dismiss="modal">Close</button>
                    <a href="<?= base_url('jadwalkuliah/delete/' . $value['id_jadwal'] . '/' . $prodi['id_prodi']) ?>" type="submit" class="btn btn-success">Delete</a>
                </div>
