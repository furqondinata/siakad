...
<div class="row">
    ...
    <div class="col-sm-12">
        <a href="<?= base_url('dsn/PrintNilai/' . $jadwal['id_jadwal']) ?>" target="_blank" class="btn btn-xs btn-success"><i class="fa fa-print"></i> Print Nilai</a>
    </div>
    <div class="col-sm-12">
        <?php
            ...
            ?>
                <tr>
                    ...
                    <td class="text-center">
                        <?php
                        $absensi = ($value['p1'] + $value['p2'] + $value['p3'] + $value['p4'] + $value['p5'] + $value['p6'] + $value['p7'] + $value['p8'] + $value['p9'] + $value['p10'] + $value['p11'] + $value['p12'] + $value['p13'] + $value['p14'] + $value['p15'] + $value['p16'] + $value['p17'] + $value['p18']) / 36 * 100;
