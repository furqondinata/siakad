        ...
        <div class="box box-success box-solid">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-toggle="modal" data-target="#add"><i class="fa fa-plus"></i>Add</button>
                </div><!-- /.box-tools -->
            </div><!-- /.box-header -->
            <div class="box-body">
                <?php
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if ($value['status'] == 0) {
                                        echo ' <small class="label text-center bg-red">Non-Aktif</small>';
                                    } else {
                                        echo ' <small class="label text-center bg-green">Aktif</small>';
                                    } ?>
                                </td>
                                <td class="text-center">
                                    <?php if ($value['status'] == 0) { ?>
                                        <a href="<?= base_url('ta/set_status_ta/' . $value['id_ta']) ?>" class="btn btn-success btn-sm"><i class="fa fa-check">Aktifkan</i></a>
                                    <?php } ?>
    ...
    <div class="modal fade" id="delete<?= $value['id_ta'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger pull-left" data-dismiss="modal">Close</button>
                    <a href="<?= base_url('ta/delete/' . $value['id_ta']) ?>" type="submit" class="btn btn-success">Delete</a>
                </div>
