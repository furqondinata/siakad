...
class Mahasiswa extends BaseController
{
    ...
    public function insert()
    {
        if ($this->validate([
            ...
            'foto_mhs' => [
                ...
                'rules' => 'uploaded[foto_mhs]|max_size[foto_mhs,1024]|mime_in[foto_mhs,image/png,image/jpeg,image/jpg,image/gif]',
                'errors' => [
                    'uploaded' => '{field} wajib disi',
            ...
            // memindahkan file foto dari form input ke folder foto di directori
    ...
    public function update($id_mhs)
    {
        if ($this->validate([
            ...
            'foto_mhs' => [
                'label' => 'Foto Mahasiswa',
                'rules' => 'max_size[foto_mhs,1024]|mime_in[foto_mhs,image/png,image/jpeg,image/jpg,image/gif]',
                'errors' => [
                    'max_size' => '{field} Max 1024 KB',
                    'mime_in' => ' Format {field} Wajib PNG, JPG, JPEG, GIF '
                ]
